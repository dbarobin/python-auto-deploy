...
def usage():
    ...
    usage.append("  [-a | --shutdown-admin] Shutdown the mall admin via the remote_shutdown.sh scripts\n")
    usage.append("  [-k | --startup-admin] Startup the mall admin  via the remote_startup.shscripts\n")
    usage.append("  [-g | --restart-admin] Restart the mall admin via the remote_restart.sh scripts\n")
    usage.append("  [-s | --shutdown-api] Shutdown the mall api via the remote_shutdown.sh scripts\n")
    usage.append("  [-t | --startup-api] Startup the mall api via the remote_startup.sh scripts\n")
    usage.append("  [-r | --restart-api] Restart the mall api via the remote_restart.sh scripts\n")
    usage.append("  [-w | --deploy-admin] Deploy mall admin via ant\n")
    usage.append("  [-d | --deploy-api] Deploy mall api via ant\n")
...
# Shutdown the mall admin via the remote_shutdown.sh scripts function.
def shutdown_admin():
...
def restart_admin():
    ...
    print green('Restart the mall admin via the remote_restart.sh scripts.')
...
# Shutdown the mall api via the remote_shutdown.sh scripts function.
def shutdown_api():
...
def startup_api():
    ...
    print green('Startup the mall api via the remote_startup.sh scripts.')
...
# Restart the mall api via the remote_restart.sh scripts function.
def restart_api():
